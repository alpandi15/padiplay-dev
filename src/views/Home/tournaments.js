        ...
        <div className="row mobile first">
          <div className="col-12 col-md-6 col-lg-4 mb-3 popular-game">
            <div style={{ cursor: 'pointer'}}>
              <img src="../../assets/img/carousel/cover2-01.jpg" className="game-cover-app" alt=""/>
              <div className="organizer">
                <img src="../../assets/img/organizer.png" className="organizer-avatar mr-2" alt=""/>
                <div>
                  <div>Tencent Cup</div>
                </div>
              </div>
          ...
          <div className="col-12 col-md-6 col-lg-4 mb-3 popular-game">
            <div style={{ cursor: 'pointer'}}>
              <img src="../../assets/img/cover/game-cover-9.png" className="game-cover-app" alt=""/>
              <div className="organizer">
                <img src="../../assets/img/organizer.png" className="organizer-avatar mr-2" alt=""/>
                <div>
                  <div>Tencent Cup</div>
